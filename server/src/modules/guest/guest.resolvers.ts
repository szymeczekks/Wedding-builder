...
export const guestResolvers = {
    Query: {},
    Mutation: {
        createGuest: async (_: any, { input: { guestListId, projectId, name, type } }: {input : { guestListId: string, projectId: string, name: string, type: string }}, __: any) => {
            return guestService.createGuest({ guestListId, projectId, name, type });
        },
